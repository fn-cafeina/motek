...
export function FormActions({ children }: { children: React.ReactNode }) {
  return <div className="sticky bottom-0 -mx-3 flex justify-end gap-2 border-t border-zinc-800 bg-zinc-900 px-3 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-3 sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:px-0 sm:pb-0 sm:pt-2">{children}</div>
}
