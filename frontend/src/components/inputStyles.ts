export function inputClassName(invalid?: boolean) {
  return `w-full rounded-md border bg-zinc-800 px-2.5 py-2 text-base text-zinc-100 placeholder:text-zinc-400 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 disabled:opacity-50 sm:py-1.5 sm:text-sm ${invalid ? "border-red-500 focus:border-red-500 focus-visible:ring-red-500" : "border-zinc-700 focus:border-amber-500"}`
}
